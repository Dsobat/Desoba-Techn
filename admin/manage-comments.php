                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Manage Approved Request</h4>
...
<strong>Well done, Request approved!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
...
<td>
<?php if($st==0):?>
    <a href="manage-comments.php?disid=<?php echo htmlentities($row['id']);?>" title="Disapprove this request"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
  <a href="manage-comments.php?appid=<?php echo htmlentities($row['id']);?>" title="Approve this request"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>
