...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>DeSoba Technologies | Add activity</title>
...
<label for="exampleInputEmail1">activity
 Title</label>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Save and Activity</button>
